...
(function () {
  document.addEventListener("DOMContentLoaded", function () {
    // Hàm dùng chung cho cả trang sản phẩm và trang chủ
    ...
    // Lấy dữ liệu từ phần tử DOM của trang chủ
    ...
    // Lấy tác giả nếu có dòng "Tác giả: ..." trong overlay
    ...
    // Bắt sự kiện click cho các nút thêm vào giỏ hàng trong trang chủ
    ...
    // Hàm để dùng ở nơi khác nếu cần
